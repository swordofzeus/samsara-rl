...
from samsara_rl.functions.manual.linear import LinearFunction
...
def sarsa_target(history: Episode, q: LinearFunction, mdp: Any, terminal: bool) -> float:
...
def qlearning_target(history: Episode, q: LinearFunction, mdp: Any, terminal: bool) -> float:
